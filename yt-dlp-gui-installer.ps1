...
New-ItemProperty -Path $key -Name "UninstallString" -Value "powershell iwr -useb https://raw.githubusercontent.com/yxcyd3871197/youtube-dlp-gui-installer/main/yt-dlp-gui-uninstaller.ps1|iex"
 -PropertyType "String"
